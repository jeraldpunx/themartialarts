<html>
	...
	<body>
	    ...
	    <input class="ancor_sidebar ancor" type="radio" checked="" name="ancor">
			...
			<div class="side-bar-footer">
				<ul>
					...
					<li class="add-student" data-toggle="modal" data-target=".bs-example-modal-lg3" style="position:absolute; right:5px; top:15px;">
						<span><a href="#">ADD NEW STUDENT</a></span>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="main-content" id="content2" style="display:none; opacity:0;">
				...
				<div class="profile-view">
					<div class="col-lg-3 profile-pic">
						<img class="picture" src="http://localhost/themartialarts/dev/assets/images/default-user.png">
					</div>
				...
				<div class="col-lg-12 other_info" style="min-height:90%;">
					...
					<div class="other_content">
						<div class="row">
								...
								<div class="content_text ">
									<div class="color">
										<div class="col-lg-2 student_style_tile">
				    						<div class="style_close"><i class="fa-times fa"></i></div>
				    						<div class="style_item" data-toggle="modal" data-target=".bs-example-modal-lg4">
				    							<div class="style_shade">
				    								<i class="fa-pencil fa-2x fa"></i>
				    							</div>
				    							<div class="style_header">Sister</div>
				    							<div class="style_content">
				    								<div class="tile_image_container">
				    									<img src="images/sample_relationship1.jpg">
				    								</div>
				    							</div>
				    							<div class="style_footer"><i class="fa-phone fa-2x fa"></i>Anna</div>
				    						</div>
					    				</div>
					    				<div class="col-lg-2 student_style_tile">
				    						<div class="style_close"><i class="fa-times fa"></i></div>
				    						<div class="style_item" data-toggle="modal" data-target=".bs-example-modal-lg4">
				    							...
				    							<div class="style_header">Mother</div>
				    							<div class="style_content">
				    								<div class="tile_image_container">
				    									<img src="images/sample_relationship2.jpg">
				    								</div>
				    							</div>
				    							<div class="style_footer"><i class="fa-dollar fa-2x fa"></i>Sarrah</div>
				    						</div>
					    				</div>
					    				<div class="col-lg-2 tile">
					    					<div class="tile_add" data-toggle="modal" data-target=".bs-example-modal-lg5">
					    						<div class="tile_content">
					    							<i class="fa fa-plus"></i>
					    							<p>ADD NEW RELATIONSHIP</p>
					    						</div>
					    					</div>
					    				</div>
									</div>
								...
								<div class="content_text ">
									<div class="color">
										<div class="col-lg-2 student_style_tile normal">
				    						<div class="style_close"><i class="fa-times fa"></i></div>
					    					<div class="style_item" data-toggle="modal" data-target=".bs-example-modal-lg1">
					    						<div class="style_shade">
					    							<i class="fa-pencil fa-2x fa"></i>
					    						</div>
					    						...
					    						<div class="style_footer"><i class="fa"><img src="images/karate_icon.png" width="100%;"></i>Black Belter</div>
					    					</div>
					    				</div>
					    				<div class="col-lg-2 student_style_tile">
				    						<div class="style_close"><i class="fa-times fa"></i></div>
					    				...
					    				<div class="col-lg-2 tile">
					    					<div class="tile_add" data-toggle="modal" data-target=".bs-example-modal-lg2">
					    						<div class="tile_content">
					    							<i class="fa fa-plus"></i>
					    							<p>ADD NEW STYLE</p>
					    						</div>
							...
							<div class="col-lg-12">
								<div class="other_content_header">Club Status</div>
							</div>
							<div class="col-lg-12">
								<div class="content_text">
									Not associated with any clubs
								</div>
							</div>
							<div class="col-lg-12">
