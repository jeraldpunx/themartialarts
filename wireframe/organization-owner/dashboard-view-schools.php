	...
	<body>
		...
		<div class="sidebar">
				...
				<ul>
					<li class="active" onclick="showStudentViewProfile(true); showReports(false); showStudentEditProfile(false);">
						<div class="student">
							...
							<span class="name">The Martial Arts University</span>
							<span class="student_title">100 active students</span>
						</div>
					</li>
			...
			<div class="side-bar-footer">
				<ul>
					<li class="num-student"><b>1</b> school(s)</li>
		...
		<div class="base-container">
					...
					<div class="col-lg-9 info-field">
						<div class="col-lg-12">
			    			<div class="form-group">
			    				<div class="name">The Martial Arts University</div>
			    			</div>
			    		</div>
					</div>
					<div class="col-lg-9">
			    		<div class="col-lg-4">
			    			<label>Owner</label>
							<div class="owner">Mickle Johanson</div>
			    		</div>
			    		<div class="col-lg-4">
				...
				<div class="col-lg-12 other_info" style="min-height:90%;">
					...
					<div class="other_content">
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="content_text ">
									<table width="100%" class="responsive table table-striped table-bordered table-hover" id="2dataTables-example" style="font-size:12px;">
						                <thead>
						                    <tr>
						                        <th>Name</th>
						                        <th>No. Students</th>
			...
			<div class="main-content" id="content3" style="display:none; opacity:0;">
				<div class="content-header">Update School</div>
