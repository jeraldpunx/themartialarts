				...
				<ul>
					<li class="active" onclick="showStudentViewProfile(true); showReports(false); showStudentEditProfile(false);">
						<div class="student">
							...
							<span class="student_title">100 Students</span>
						</div>
					</li>
					<li onclick="showStudentViewProfile(true); showReports(false); showStudentEditProfile(false);">
						<div class="student">
							...
							<span class="student_title">50 Students</span>
						</div>
					</li>
					<li onclick="showStudentViewProfile(true); showReports(false); showStudentEditProfile(false);">
						<div class="student">
							<img src="../images/default-user.png">
							<span class="name">Muaitai</span>
							<span class="student_title">40 Students</span>
						</div>
					</li>
				</ul>
			</div>
					...
					<div class="col-lg-9 info-field">
						<div class="col-lg-12">
			    			<div class="form-group">
			    				<div class="name"><span class="class_name">Judo</span></div>
			    			</div>
			    		</div>
					</div>
					<div class="col-lg-9">
						<div class="col-lg-4 info-field">
			    			<label>School</label>
			    			<div class="description">The Martial Arts University</div>
			    		</div>
			    		<div class="col-lg-4 info-field">
			    			<label>Description</label>
			    			<div class="description">Judo is asdsdsd.</div>
			    		</div>
			    		<div class="col-lg-4 info-field">
			    			<label>Instructor</label>
			    			<div>Samuel Tarley</div>
			    		</div>
			    		<div class="col-lg-4 info-field">
