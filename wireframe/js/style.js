function style_list(element,modal){
	...
	this.returnData = function()
	{
		...
		for(var i = 0; i < this.styles.length; i++)
		{
			...
			{
				ranks.push({rank_name:this.styles[i].ranks[x].name,primary_color:this.styles[i].ranks[x].primary_color,secondary_color:this.styles[i].ranks[x].secondary_color,pattern:this.styles[i].ranks[x].patern});
			}
	...
	this.validate_current_style = function()
	{
		...
		{
			alert("Please fill up the style name field");
			return false;
		}

		if(modal.getElementsByClassName('style_description')[0].value == "")
		{
			alert("Please fill up the style desctiption");
			return false;
		}
	...
	this.validate_current_rank = function()
	{
		...
		{
			alert("Please fill up the rank name field");
			return false;
		}
