...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/unick_helptip.css">
	...
	<div class="container">
		<div class="group_content col-lg-12">
			...
			<div class="group_tile">
				<div class="form-group col-lg-12">
					<input type="text" placeholder="School Name" class="form-control" name="">
				</div>
			</div>
		</div>
		<div class="group_content col-lg-12">
			...
			<div class="group_tile">
				...
				<div class="form-group col-lg-6">
					<input type="text" placeholder="Surename" class="form-control" name="">
				</div>
				<div class="form-group col-lg-12">
					<input type="email" placeholder="Email" class="form-control" name="">
				</div>
				<div class="form-group col-lg-6">
					<input type="email" placeholder="Password" class="form-control" name="">
				</div>
				<div class="form-group col-lg-6">
					<input type="email" placeholder="Re-type Password" class="form-control" name="">
				</div>
			</div>
		</div>
		<div class="group_content col-lg-12">
			<div class="group_header col-lg-12">
				...
				<div class="unick_helptip">
					...
					<div class="tip_message">
						<div class="pointer"></div>
						The School portion of these field requirements is where you'll be writing your school name, address and other important information.
					</div>
				</div>
			</div>
			<div class="group_tile">
				...
				<div class="form-group col-lg-8">
					<input type="text" placeholder="Street Address" class="form-control" name="">
				</div>
				<div class="form-group col-lg-4">
					<input type="text" placeholder="Suburb" class="form-control" name="">
				</div>
				<div class="form-group col-lg-5">
					<input type="text" placeholder="Country" class="form-control" name="">
				</div>
				<div class="form-group col-lg-5">
					<input type="text" placeholder="State" class="form-control" name="">
				</div>
				<div class="form-group col-lg-2">
					<input type="text" placeholder="Zip" class="form-control" name="">
				</div>
				<div class="form-group col-lg-8">
					<input type="text" placeholder="Location Nickname" class="form-control" name="">
				</div>
				<div class="form-group col-lg-4">
		...
		<div class="group_content col-lg-12" style="border-top:1px solid #cecece">
			<div class="blue-bttn unick-bttn" id="submit_all" style="padding:20px; float:right; font-weight:bold; color:white; font-size:20px; text-align:center; min-width:200px;">
				<a href="#"><labelname>Submit</labelname></a>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content rs_edit_popup" style="background:#ececec;">
			...
			<div class="main_container rank_container_view">
				...
				<div class="rank_edit_bttn">
					<div class="gray-bttn unick-bttn" style="float:right">
						<i class="fa">Cancel</i>
					</div>
