		...
		<div id="menu" class="navbar navbar-default navbar-fixed-top">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-left" id="nav_bar">
					<li class="nav {{ Helper::setActive('owner_home') }}"><a href="{{ URL::route('owner_home') }}">Students</a></li>
					<li class="nav {{ Helper::setActive('owner_styles') }}"><a href="{{ URL::route('owner_styles') }}">Styles</a></li>
				</ul>
			</div>
		</div>
	</header>
