function style_list(element,modal){
	...
	this.validate_current_style = function()
	{
		...
		if(!(/[a-zA-Z]/.test(modal.getElementsByClassName('stylename')[0].value)))
		{
			$(modal.getElementsByClassName('stylename')[0].parentNode).addClass('has-feedback');
			return false;
		}

		if(!(/[a-zA-Z]/.test(modal.getElementsByClassName('style_description')[0].value)))
		{
	...
	this.validate_current_rank = function()
	{
		...
		if(!(/[a-zA-Z]/.test(modal.getElementsByClassName('rankName')[0].value)))
		{
